...
create temporary table dump_story_link_counts $_temporary_tablespace as
    select distinct ps.stories_id, 
            ...
            bitly_story_statistics.click_count as bitly_click_count,
            bitly_story_statistics.referrer_count as bitly_referrer_count
        from dump_period_stories ps
            ...
            left join bitly_story_statistics
                on ps.stories_id = bitly_story_statistics.stories_id
END
