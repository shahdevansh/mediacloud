...
-- versions 4490 and 4491.
--
-- If you are running Media Cloud with a database that was set up with a schema version
-- 4490, and you would like to upgrade both the Media Cloud and the
-- database to be at version 4491, import this SQL file:
--
--     psql mediacloud < mediawords-4490-4491.sql
--
